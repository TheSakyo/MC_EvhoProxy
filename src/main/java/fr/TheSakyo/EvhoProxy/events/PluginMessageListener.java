...
public class PluginMessageListener implements Listener {
	...
	/**************************************************************/
	/* ÉVÈNEMENT POUR RECUPERER DES INFORMATIONS VENANT DE BUKKIT */ 
	/**************************************************************/
		...
		try {
			...
			if(subChannel.equalsIgnoreCase("BungeeCount")) {
				...
				if(e.getReceiver() instanceof ProxiedPlayer p) {
					...
					if(p.isConnected()) sendCustomDataCountPlayers(p, server, false);
					else sendCustomDataCountPlayers(p, server, true);
				}
