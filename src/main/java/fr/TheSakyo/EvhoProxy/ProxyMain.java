...
public class ProxyMain extends Plugin {
	...
	public List<ProxiedPlayer> freezeP = new ArrayList<>();
	// Variable pour la liste des joueurs "Freeze" //
    ...
    public CustomMethod methodCustom = new CustomMethod();
	...
	public HashMap<ProxiedPlayer, String> playerCustomName = new HashMap<>();
	// Variable permettant d'enregistrer les Noms Customisés des Joueurs (nickname) //


	// Variable permettant d'enregistrer les Skins Customisés des Joueurs (changeskin) //
	public HashMap<ProxiedPlayer, String> playerSkinName = new HashMap<>();
	// Variable permettant d'enregistrer les Skins Customisés des Joueurs (changeskin) //
	...
	// Instance et Importation Plugin des différents API (utile pour lire ses class ensuite) //
