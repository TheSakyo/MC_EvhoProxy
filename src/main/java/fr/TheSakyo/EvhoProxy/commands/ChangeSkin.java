...
public class ChangeSkin extends Command {
	...
	/********************************************************/
	  ...
	  public void execute(CommandSender sender, String[] args) {
		  ...
		  if(args.length == 1) {
			  ...
			  if(args[0].equalsIgnoreCase("reset")) { resetSkin(sender, args); return; }

		  } else if(args.length >= 2) {

			  if(args[1].equalsIgnoreCase("reset")) { resetSkin(sender, args); return; }
		  }
	...
	public void SkinChange(CommandSender commandSender, String[] strings) {
		...
		else { commandSender.sendMessage(error); return; }
